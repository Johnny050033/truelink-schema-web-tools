...
interface ImportMetaEnv {
  ...
  /**
   * Same-origin path of the TrueLink host bridge page, e.g. /studio/host.html. Enables cloud drafts, and
   * TrueLink's language setting (window.TLLocale) then picks the first-run language.
   */
